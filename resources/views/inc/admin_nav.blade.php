<nav class="navbar navbar-inverse">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
              <li><a href="/ATC/public/airport">SLOT</a></li>
              <li><a href="/ATC/public/iata">IATA</a></li>
              <li><a href="/ATC/public/addflight"><i class="fas fa-plus-circle"></i></a></li>
                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="/ATC/public/admin"><i class="fas fa-chart-line"></i> Dashboard</a></li>
